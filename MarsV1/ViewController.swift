...
//  MarsV1
//
//  Created by capstone1_7 on 2018. 5. 18..
...
class ViewController: UIViewController, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        guard let feature = Feature(rawValue: component) else {
            fatalError("Inavalid component \(component) found to represent a \(Feature.self). This should not happen based on the configuration set in the storyboard.")
        }
